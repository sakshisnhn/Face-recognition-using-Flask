...
#   1. Process each video frame at 1/4 resolution (though still display it at full resolution) we can change the resolution as per the demand
#   2. Only detect faces in every other frame of video. It takes multiple photos with diffrent angle
